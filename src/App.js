...
function App() {
  ...
  return (
    <div className="bg-[#262837] w-full min-h-screen">
      ...
      <main className="lg:pl-32 grid-cols-1 lg:grid-cols-8  pb-20">
        <div>Hola1</div>
    ...
    >
          ...
          <div className="relative pt-16 lg:pt-8 text-gray-300 p-8 h-full ">
            ...
            className="lg:hidden absolute left-4 top-4 p-3 box-content text-gray-300 bg-[#262837] rounded-full"/> 
